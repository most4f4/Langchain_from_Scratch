...
# -------------------------------------------------------------
# This script demonstrates various text splitting techniques
# and their impact on creating vector stores for RAG applications.
# Each splitting method is used to create a separate vector store,
...
# This is a more advanced splitter that tries to respect natural text boundaries.
