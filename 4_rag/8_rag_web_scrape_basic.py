...
# --------------------------------------------------------------------------------------------
# This script demonstrates a basic retrieval-augmented generation (RAG) system.
# It scrapes content from a specified website, processes the content into chunks,
# creates embeddings, and stores them in a vector store.
# It then allows querying the vector store to retrieve relevant documents based on a user's question.
# --------------------------------------------------------------------------------------------
