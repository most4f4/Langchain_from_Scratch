...
# -------------------------------------------------------------
# This script demonstrates different retrieval methods for querying
# a vector store in RAG applications.
# It showcases similarity search, Max Marginal Relevance (MMR),
# and similarity score threshold techniques.
# Each method is used to query the same vector store,
# and the results are compared to understand their differences.
# -------------------------------------------------------------
...
print("Books found:", book_files)
print("Total docs in store:", db._collection.count())
print("First doc metadata:", db.get(include=['metadatas'], limit=1))
