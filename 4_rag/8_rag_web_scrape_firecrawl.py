...
# ---------------------------------------------------------------
# This script demonstrates how to use FireCrawl to scrape a website,
# create embeddings, store them in a Chroma vector store, and query the store.
# ---------------------------------------------------------------
...
def create_vector_store():
    ...
    loader = FireCrawlLoader(
        api_key=api_key, url="https://apple.com", mode="scrape") # mode can be "scrape", "screenshot", or "both". "scrape" is used here to get text content.
    docs = loader.load()
