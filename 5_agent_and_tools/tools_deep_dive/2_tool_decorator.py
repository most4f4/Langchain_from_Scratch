...
# ---------------------------------------------------------------
# This script demonstrates how to create a ReAct agent that can use
# both simple and structured tools to perform various tasks.
# @tool decorator simplifies the creation of tools. It can be used
# for both simple tools (single parameter) and complex tools (multiple parameters).
# The args_schema parameter allows defining input schemas using Pydantic models.
# ---------------------------------------------------------------
